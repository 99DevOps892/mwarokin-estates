...
SELECT title, slug, description, property_type, status, price, deposit, bedrooms, bathrooms, area_sqft, location, city, county, country, amenities::jsonb, images::jsonb, is_featured FROM (VALUES
